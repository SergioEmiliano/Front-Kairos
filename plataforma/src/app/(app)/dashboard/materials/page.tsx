...
import { mockMaterials, materialCategoryLabels, materialTypeLabels } from "@/mock/materials";
        ...
        >
          ...
          <div className="relative">
            ...
            <p className="text-[14px] text-kairos-stone leading-[1.55] max-w-[480px] mb-6">
              Guias, e-books e checklists curados exclusivamente para médicas da
              estética — do protocolo clínico ao crescimento digital.
            </p>
