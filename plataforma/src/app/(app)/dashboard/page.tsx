...
import { PlanNextWeekPanel } from "@/components/dashboard/PlanNextWeekPanel";
import { ContentGenerationModal } from "@/components/dashboard/ContentGenerationModal";
import { ContentViewModal } from "@/components/dashboard/ContentViewModal";
    ...
    <div className="h-full flex flex-col overflow-hidden p-6 gap-4">
      ...
      <div className="flex items-end justify-between gap-6 shrink-0">
        <div className="min-w-0">
          <span className="kicker">Calendário IA · {periodLabel}</span>
          <h1
            className="text-[32px] text-kairos-charcoal leading-[1.05] mt-2.5 font-medium"
            style={{ letterSpacing: "-0.025em" }}
          >
            Olá, {firstName}.{" "}
            <span className="italic-gold">Seu mês em estrutura.</span>
          </h1>
        </div>
        ...
        <div className="hidden md:flex items-end gap-6 shrink-0">
          {[
            ...
            { label: "Leads qualificadas", value: "47", sub: "META · 65", italic: false },
            { label: "Alcance acumulado", value: "32,4K", sub: "+38% VS MARÇO", italic: false },
      ...
      <div className="card-surface flex-1 min-h-0 flex flex-col overflow-hidden">
        ...
        <div className="px-5 py-3 border-t border-kairos-line flex gap-5 flex-wrap items-center shrink-0">
          ...
          <span className="mono-label">◆ Recalibrado há 02 min</span>
        </div>
      </div>
