...
import { PlannedPost, ContentFormat } from "@/shared/types";
    ...
    <>
      ...
      >
        ...
        <div className="px-6 py-4 border-b border-kairos-line flex items-start justify-between gap-4 shrink-0">
          <div>
            <span className="kicker">Kairós · Planejamento semanal</span>
            <h2
            ...
            <div className="h-full flex flex-col items-center justify-center gap-6 text-center">
              ...
              <div className="max-w-[360px]">
                <p className="text-[15px] text-kairos-charcoal font-medium" style={{ letterSpacing: "-0.01em" }}>
                  Não sabe o que publicar? Nós sugerimos os próximos conteúdos com base no
                  seu planejamento atual.
                </p>
