...
import { CancelSubscriptionModal } from "@/app/(plataform)/dashboard/settings/components/CancelSubscriptionModal";
import { DnaModal } from "@/app/(plataform)/dashboard/settings/components/DnaModal";
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden p-6 gap-4">
      ...
      <div className="shrink-0">
        ...
        >
          Meus <span className="italic-gold">ajustes</span>.
        </h1>
      </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 h-full">
            ...
            <div className="card-surface rounded-[var(--radius)] p-6 overflow-hidden flex flex-col">
              ...
              <p className="text-[12px] text-kairos-stone mb-4">
                Essas informações refinam o tom do sistema.
              </p>
