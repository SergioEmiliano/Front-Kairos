import { AnalyticsSummary, GeneratedContent, ContentFormat } from "@/types";
...
export const mockAnalytics: AnalyticsSummary = {
  ...
  revenuePercent: 75,
  weekly: [
    { week: "S1", dms: 18, appointments: 6, sales: 4, reach: 3200, engagement: 4.2 },
    { week: "S2", dms: 15, appointments: 5, sales: 3, reach: 2800, engagement: 3.8 },
    { week: "S3", dms: 21, appointments: 8, sales: 5, reach: 4100, engagement: 5.1 },
    { week: "S4", dms: 10, appointments: 4, sales: 3, reach: 1900, engagement: 3.2 },
  ],
};
